...
export class PostController {
  ...
  @Get('/single/:postId')
  async getSinglePost(@Param('postId') postId: number) {
  ...
  @Patch('like/:postId')
  async likePost(@Req() req: RequestWithUser, @Param('postId') postId: number) {
  ...
  @Get('/likes/:postId')
  async getLikesOfPost(@Param('postId') postId: number) {
  ...
  async deleteComment(
    ...
    return await this.postService.deleteComment(postId, commentId, req.user.id);
  }
}
