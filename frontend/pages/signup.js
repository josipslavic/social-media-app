...
function Signup() {
  const {
    ...
    username: 'jslavic',
    bio: 'Ja sam josip',
    facebook: 'http://localhost:3000/signup',
    youtube: 'http://localhost:3000/signup',
    twitter: 'http://localhost:3000/signup',
    instagram: 'http://localhost:3000/signup',
  });
  ...
  const checkUsername = async (value = '') => {
    try {
      ...
      await axios.get(`${baseUrl}/auth/is-taken/${value}`, {
